...
int main (int argc, char** argv)
{
	...
	//Connect to ROS
	ros::init(argc, argv, "ck_gr_a_node");
	ROS_INFO("Node ck_gr_a_node connected to roscore");

// ------------- 
// Your modifications should be within the two commented dashed lines.    

        ros::NodeHandle nh_loc;//ROS Handler

        pub_key = nh_loc.advertise<std_msgs::Int16>("the_key_typed", 1);
